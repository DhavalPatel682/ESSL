  ...
  .school-list {
    ...
    color: #fff;
    max-height: 400px; /* Optional: set a max height for the list */
  ...
  .school-table-container {
    ...
    padding: 10px;
    border-radius: 5px;
    max-height: 400px; /* Optional: set a max height for the table */
    overflow-y: auto; /* Allow scrolling */
  }
  ...
  .district-list {
    ...
    text-align: center; /* Center align the text */
    color: #fff;
    max-height: 400px; /* Optional: set a max height for the district list */
    overflow-y: auto; /* Allow scrolling */
  }
  </style>
